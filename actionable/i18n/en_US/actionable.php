<?php defined('SYSPATH') or die('No direct script access.');
	$lang = array(
		...
		'dropped_summary_description' => 'Add details about why the complaint has been dropped',
		'summary' => 'Summary',
		'action_needed' => 'Action needed',
		'action_date' => 'Date of action',
		'resolution_date' => 'Date of resolution',
		'legal_date' => 'Date legal case was opened',
		'dropped_date' => 'Date report was dropped ',
		'all' => 'All',
		...
		'dropped_message' => 'Person who created report has decided to drop it'
	);
?>
