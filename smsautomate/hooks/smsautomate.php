you<?php defined('SYSPATH') or die('No direct script access.');
/**
...
//if($goodFormat){
		if($message_elements[0]=="170404"){			
		...
		else if($message_elements[0]=="171206"){			
			$location_description = "Bolonco";
			$facilityType = "Puesto de Salud";
			$municipality = "Fray Bartolome De Las Casas";
			$department = "Alta Verapaz";
			$dms = "Fray Bartolome De Las Casas";
			$das = "Alta Verapaz";
			$location_lat = 15.84860327;
			$location_long = -89.73766926;
		}
		else if($message_elements[0]=="171205"){			
			$location_description = "Chajmaic";
			$facilityType = "Puesto de Salud";
			$municipality = "Fray Bartolome De Las Casas";
			$department = "Alta Verapaz";
			$dms = "Fray Bartolome De Las Casas";
			$das = "Alta Verapaz";
			$location_lat = 15.75561264;
			$location_long = -89.94105291;
		}
		else if($message_elements[0]=="171207"){			
			$location_description = "Tuila";
			$facilityType = "Puesto de Salud";
			$municipality = "Fray Bartolome De Las Casas";
			$department = "Alta Verapaz";
			$dms = "Fray Bartolome De Las Casas";
			$das = "Alta Verapaz";
			$location_lat = 15.94234998;
			$location_long = -89.64054434;
		}
		else if($message_elements[0]=="171231"){			
			$location_description = "Hospital Distrital Fray Bartolome De Las Casas";
			$facilityType = "Hospital";
			$municipality = "Fray Bartolome De Las Casas";
			$department = "Alta Verapaz";
			$dms = "Fray Bartolome De Las Casas";
			$das = "Alta Verapaz";
			$location_lat = 15.80177151;
			$location_long = -89.86962266;
		}
		else if($message_elements[0]=="171504"){			
			$location_description = "Nueva Palestina";
			$facilityType = "Puesto de Salud";
			$municipality = "La Tinta";
			$department = "Alta Verapaz";
			$dms = "La Tinta";
			$das = "Alta Verapaz";
			$location_lat = 15.26728272;
			$location_long = -89.78827052;
		}
		else if($message_elements[0]=="171532"){			
			$location_description = "Hospital Distrital La Tinta";
			$facilityType = "Hospital";
			$municipality = "La Tinta";
			$department = "Alta Verapaz";
			$dms = "La Tinta";
			$das = "Alta Verapaz";
			$location_lat = 15.31701305;
			$location_long = -89.87652598;
		}
		else if($message_elements[0]=="170101"){			
			$location_description = "Lanquin";
			$facilityType = "Centro de Salud";
			$municipality = "Lanquin";
			$department = "Alta Verapaz";
			$dms = "Lanquin";
			$das = "Alta Verapaz";
			$location_lat = 15.57918516;
			$location_long = -89.97633207;
		}
		else if($message_elements[0]=="171604"){			
			$location_description = "San Cristobal Verapaz";
			$facilityType = "Centro de Salud";
			$municipality = "San Cristobal Verapaz";
			$department = "Alta Verapaz";
			$dms = "San Cristobal Verapaz";
			$das = "Alta Verapaz";
			$location_lat = 15.36215335;
			$location_long = -90.49023208;
		}
			else if($message_elements[0]=="171605"){			
			$location_description = "El Rancho";
			$facilityType = "Puesto de Salud";
			$municipality = "San Cristobal Verapaz";
			$department = "Alta Verapaz";
			$dms = "San Cristobal Verapaz";
			$das = "Alta Verapaz";
			$location_lat = 15.42096894;
			$location_long = -90.55770275;
		}
		else if($message_elements[0]=="171606"){			
			$location_description = "Santa Elena";
			$facilityType = "Puesto de Salud";
			$municipality = "San Cristobal Verapaz";
			$department = "Alta Verapaz";
			$dms = "San Cristobal Verapaz";
			$das = "Alta Verapaz";
			$location_lat = 15.37327071;
			$location_long = -90.62442412;
		}
		else if($message_elements[0]=="170702"){			
			$location_description = "Tamahu";
			$facilityType = "Centro de Salud";
			$municipality = "Tamahu";
			$department = "Alta Verapaz";
			$dms = "Tamahu";
			$das = "Alta Verapaz";
			$location_lat = 15.3057605;
			$location_long = -90.23440625;
		}
		...
		else if($message_elements[0]=="132503"){			
			$location_description = "San Juan Ixcoy";
			$facilityType = "Centro de Atencion Permanente";
			$municipality = "San Juan Ixcoy";
			$department = "Huehuetenango";
			$dms = "San Juan Ixcoy";
			$das = "Huehuetenango";
			$location_lat = 15.59562896;
			$location_long = -91.35780426;
		}
		else if($message_elements[0]=="132504"){			
			$location_description = "Yajaucu Signup";
			$facilityType = "Puesto de Salud";
			$municipality = "San Juan Ixcoy";
			$department = "Huehuetenango";
			$dms = "San Juan Ixcoy";
			$das = "Huehuetenango";
			$location_lat = 15.59782992;
			$location_long = -91.44742795;
		}
		else if($message_elements[0]=="132201"){			
			$location_description = "Santa Barbara";
			$facilityType = "Centro de Atencion Permanente";
			$municipality = "Santa Barbara";
			$department = "Huehuetenango";
			$dms = "Santa Barbara";
			$das = "Huehuetenango";
			$location_lat = 15.31503159;
			$location_long = -91.63473545;
		}
		else if($message_elements[0]=="133203"){			
			$location_description = "Cruz Quemada";
			$facilityType = "Puesto de Salud";
			$municipality = "Santa Barbara";
			$department = "Huehuetenango";
			$dms = "Santa Barbara";
		...
		else if($message_elements[0]=="133202"){			
			$location_description = "Sacpic";
			$facilityType = "Puesto de Salud";
			$municipality = "Santa Barbara";
			$department = "Huehuetenango";
			$dms = "Santa Barbara";
			$das = "Huehuetenango";
			$location_lat = 15.28090934; 	
			$location_long = -91.61072911;
		}
		else if($message_elements[0]=="132814"){			
			$location_description = "Cerro Maltin";
			$facilityType = "Puesto de Salud";
			$municipality = "Santa Eulalia";
			$department = "Huehuetenango";
			$dms = "Santa Eulalia";
			$das = "Huehuetenango";
			$location_lat = 0;//MISSING 	
		...
		else if($message_elements[0]=="132810"){			
			$location_description = "Chojusunil";
			$facilityType = "Puesto de Salud";
			$municipality = "Santa Eulalia";
			$department = "Huehuetenango";
			$dms = "Santa Eulalia";
			$das = "Huehuetenango";
			$location_lat = 15.72739257; 	
			$location_long = -91.26265139;
		}
		else if($message_elements[0]=="132813"){			
			$location_description = "Pett";
			$facilityType = "Puesto de Salud";
			$municipality = "Santa Eulalia";
			$department = "Huehuetenango";
			$dms = "Santa Eulalia";
			$das = "Huehuetenango";
			$location_lat = 15.73866339;
			$location_long = -91.49948624;
		}
		else if($message_elements[0]=="132806"){			
			$location_description = "Quixabaj";
			$facilityType = "Puesto de Salud";
			$municipality = "Santa Eulalia";
			$department = "Huehuetenango";
			$dms = "Santa Eulalia";
			$das = "Huehuetenango";
			$location_lat = 15.71794795;
			$location_long = -91.21808319;
		}
		else if($message_elements[0]=="132805"){			
			$location_description = "Temux Grande";
			$facilityType = "Puesto de Salud";
			$municipality = "Santa Eulalia";
			$department = "Huehuetenango";
			$dms = "Santa Eulalia";
			$das = "Huehuetenango";
			$location_lat = 15.7582745;
			$location_long = -91.53014929;
		}
		else if($message_elements[0]=="132811"){			
			$location_description = "Wayacoy";
			$facilityType = "Puesto de Salud";
			$municipality = "Santa Eulalia";
			$department = "Huehuetenango";
			$dms = "Santa Eulalia";
		...
		else if($message_elements[0]=="132812"){			
			$location_description = "Yichjoyom";
			$facilityType = "Puesto de Salud";
			$municipality = "Santa Eulalia";
			$department = "Huehuetenango";
			$dms = "Santa Eulalia";
			$das = "Huehuetenango";
			$location_lat = 15.75274284;
			$location_long = -91.44467161;
		}
		else if($message_elements[0]=="132804"){			
			$location_description = "Santa Eulalia";
			$facilityType = "Puesto de Salud Fortalecido";
			$municipality = "Santa Eulalia";
			$department = "Huehuetenango";
			$dms = "Santa Eulalia";
			$das = "Huehuetenango";
			$location_lat = 15.732451;
			$location_long = -91.45660585;
		}
		else if($message_elements[0]=="131103"){			
			$location_description = "Soloma";
			$facilityType = "Centro de Atencion Fortalecido";
			$municipality = "San Pedro Soloma";
			$department = "Huehuetenango";
			$dms = "Soloma";
			$das = "Huehuetenango";
			$location_lat = 15.65718937;
			$location_long = -91.4309128;
		}
		else if($message_elements[0]=="131128"){			
			$location_description = "Crinolina";
			$facilityType = "Puesto de Salud";
			$municipality = "San Pedro Soloma";
			$department = "Huehuetenango";
			$dms = "Soloma";
		...
		else if($message_elements[0]=="131129"){			
			$location_description = "Gema";
			$facilityType = "Puesto de Salud";
			$municipality = "San Pedro Soloma";
			$department = "Huehuetenango";
			$dms = "Soloma";
		...
		else if($message_elements[0]=="131126"){			
			$location_description = "Najab";
			$facilityType = "Puesto de Salud";
			$municipality = "San Pedro Soloma";
			$department = "Huehuetenango";
			$dms = "Soloma";
		...
		else if($message_elements[0]=="260302"){			
			$location_description = "San Juan Cotzal";
			$facilityType = "Centro de Atencion Permanente";
			$municipality = "San Juan Cotzal";
			$department = "Quiche";
			$dms = "San Juan Cotzal";
			$das = "Ixil";
			$location_lat = 15.43601166;
			$location_long = -91.02914872;
		}
		else if($message_elements[0]=="260305"){			
			$location_description = "Chichel";
			$facilityType = "Puesto de Salud";
			$municipality = "San Juan Cotzal";
			$department = "Quiche";
			$dms = "San Juan Cotzal";
			$das = "Ixil";
			$location_lat = 15.4646142;
			$location_long = -90.98973253;
		}	
		else if($message_elements[0]=="260306"){			
			$location_description = "Ojo de Agua";
			$facilityType = "Puesto de Salud";
			$municipality = "San Juan Cotzal";
			$department = "Quiche";
			$dms = "San Juan Cotzal";
			$das = "Ixil";
			$location_lat = 15.40037523;
			$location_long = -91.05436415;
		}	
		else if($message_elements[0]=="260304"){			
			$location_description = "San Felipe Chenla";
			$facilityType = "Puesto de Salud";
			$municipality = "San Juan Cotzal";
			$department = "Quiche";
			$dms = "San Juan Cotzal";
			$das = "Ixil";
			$location_lat = 15.44411553;
			$location_long = -91.00947845;
		}	
		else if($message_elements[0]=="260303"){			
			$location_description = "Santa Avelina";
			$facilityType = "Puesto de Salud";
			$municipality = "San Juan Cotzal";
			$department = "Quiche";
			$dms = "San Juan Cotzal";
			$das = "Ixil";
			$location_lat = 15.45367371;
			$location_long = -90.96298396;
		}	
		else if($message_elements[0]=="260307"){			
			$location_description = "Vichibala";
			$facilityType = "Puesto de Salud";
			$municipality = "San Juan Cotzal";
			$department = "Quiche";
			$dms = "San Juan Cotzal";
			$das = "Ixil";
			$location_lat = 15.44916504;
			$location_long = -90.98121482;
		}	
		else if($message_elements[0]=="140802"){			
			$location_description = "San Bartolome Jocotenango";
			$facilityType = "Centro de Atencion Permanente";
			$municipality = "San San Bartolome Jocotenango";
			$department = "Quiche";
			$dms = "San Bartolome Jocotenango";
			$das = "Quiche";
			$location_lat = 15.19049862;
			$location_long = -91.07490363;
		}	
		else if($message_elements[0]=="140801"){			
			$location_description = "Los Cimientos";
			$facilityType = "Puesto de Salud";
			$municipality = "San San Bartolome Jocotenango";
			$department = "Quiche";
			$dms = "San Bartolome Jocotenango";
			$das = "Quiche";
			$location_lat = 15.22440018;
			$location_long = -91.02882247;
		}	
		else if($message_elements[0]=="142203"){			
			$location_description = "San Pedro Jocopilas";
			$facilityType = "Centro de Atencion Permanente";
			$municipality = "San Pedro Jocopilas";
			$department = "Quiche";
			$dms = "San Pedro Jocopilas";
			$das = "Quiche";
			$location_lat = 15.09535929;
			$location_long = -91.15164892;
		}	
		else if($message_elements[0]=="142205"){			
			$location_description = "Comitancillo";
			$facilityType = "Puesto de Salud";
			$municipality = "San Pedro Jocopilas";
			$department = "Quiche";
			$dms = "San Pedro Jocopilas";
			$das = "Quiche";
			$location_lat = 15.23020532;
			$location_long = -91.24016449;
		}	
		else if($message_elements[0]=="142204"){			
			$location_description = "La Primavera";
			$facilityType = "Puesto de Salud";
			$municipality = "San Pedro Jocopilas";
			$department = "Quiche";
			$dms = "San Pedro Jocopilas";
			$das = "Quiche";
			$location_lat = 15.17356228;
			$location_long = -91.19922691;
		}	
		else if($message_elements[0]=="142206"){			
			$location_description = "Santa Maria Jocopilas";
			$facilityType = "Puesto de Salud";
			$municipality = "San Pedro Jocopilas";
			$department = "Quiche";
			$dms = "San Pedro Jocopilas";
			$das = "Quiche";
			$location_lat = 15.22636521;
			$location_long = -91.27056079;
		}	
		...
		else if($message_elements[0]=="71002"){			
			$location_description = "San Marcos La Laguna";
			$facilityType = "Centro de Atencion Permanente";
			$municipality = "San Marcos La Laguna";
			$department = "Solola";
			$dms = "San Pablo La Laguna";
			$das = "Solola";
			$location_lat = 14.72520671;
			$location_long = -91.25705542; 
		}
		else if($message_elements[0]=="71001"){			
			$location_description = "San Pablo La Laguna";
			$facilityType = "Centro de Atencion Permanente";
			$municipality = "San Pablo La Laguna";
			$department = "Solola";
			$dms = "San Pablo La Laguna";
			$das = "Solola";
			$location_lat = 14.71968488;
			$location_long = -91.27254408; 
		}
		else if($message_elements[0]=="71003"){			
			$location_description = "Santa Cruz La Laguna";
			$facilityType = "Centro de Atencion Permanente";
			$municipality = "Santa Cruz La Laguna";
			$department = "Solola";
			$dms = "San Pablo La Laguna";
			$das = "Solola";
			$location_lat = 14.74379306;
			$location_long = -91,20664677; 
		}
		else if($message_elements[0]=="71010"){			
			$location_description = "Jaibalito";
			$facilityType = "Puesto de Salud";
			$municipality = "Santa Cruz La Laguna";
			$department = "Solola";
			$dms = "San Pablo La Laguna";
			$das = "Solola";
			$location_lat = 14.73882387;
			$location_long = -91.21934429; 
		}
		else if($message_elements[0]=="71004"){			
			$location_description = "Tzunuma";
			$facilityType = "Puesto de Salud";
			$municipality = "Santa Cruz La Laguna";
			$department = "Solola";
			$dms = "San Pablo La Laguna";
			$das = "Solola";
			$location_lat = 14.72986605;
			$location_long = -91.244607; 
		}
		else if($message_elements[0]=="70113"){			
			$location_description = "Concepción";
			$facilityType = "Centro de Atencion Permanente";
			$municipality = "Concepción";
			$department = "Solola";
			$dms = "Solola";
			$das = "Solola";
			$location_lat = 14.78420421;
			$location_long = -91.14672417; 
		}
		else if($message_elements[0]=="71004"){			
			$location_description = "Patzutzun";
			$facilityType = "Puesto de Salud";
			$municipality = "Concepción";
			$department = "Solola";
			$dms = "Solola";
			$das = "Solola";
			$location_lat = 14.80545511;
			$location_long = -91.12009967; 
		}
		...
		else if($message_elements[0]=="80401"){			
			$location_description = "San Andres Xecul";
			$facilityType = "Centro de Atencion Permanente";
			$municipality = "San Andres Xecul";
			$department = "Totonicapan";
			$dms = "San Andres Xecul";
			$das = "Totonicapan";
			$location_lat = 14.90478802;
			$location_long = -91.48012373; 
		}
		else if($message_elements[0]=="80402"){			
			$location_description = "Palomora";
			$facilityType = "Puesto de Salud";
			$municipality = "San Andres Xecu";
			$department = "Totonicapan";
			$dms = "San Andres Xecu";
			$das = "Totonicapan";
			$location_lat = 14.92300125;
			$location_long = -91.50018673;
		}
		else if($message_elements[0]=="80301"){			
			$location_description = "San Bartolo";
			$facilityType = "Centro de Atencion Permanente";
			$municipality = "San Bartolo";
			$department = "Totonicapan";
			$dms = "San Bartolo Aguas Calientes";
			$das = "Totonicapan";
			$location_lat = 15.08288865;
			$location_long = -91.45524796; 
		}
		else if($message_elements[0]=="80302"){			
			$location_description = "Tierra Blanca PSF";
			$facilityType = "Puesto de Salud Fortalecido";
			$municipality = "San Bartolo";
			$department = "Totonicapan";
			$dms = "San Bartolo Aguas Calientes";
			$das = "Totonicapan";
			$location_lat = 15.11121101;
			$location_long = -91.51754146;
		}
		else if($message_elements[0]=="80301"){			
			$location_description = "San Cristobal Totonicapan";
			$facilityType = "Centro de Atencion Permanente";
			$municipality = "San Cristobal Totonicapan";
			$department = "Totonicapan";
			$dms = "San Cristobal Totonicapan";
			$das = "Totonicapan";
			$location_lat = 14.91815118;
			$location_long = -91.44309638; 
		}
		else if($message_elements[0]=="80111"){			
			$location_description = "Nueva Candelaria";
			$facilityType = "Puesto de Salud Fortalecido";
			$municipality = "San Cristobal Totonicapan";
			$department = "Totonicapan";
			$dms = "San Cristobal Totonicapan";
			$das = "Totonicapan";
			$location_lat = 14.9512946;
			$location_long = -91.5316669;
		}	
		else if($message_elements[0]=="80105"){			
			$location_description = "Patachaj";
			$facilityType = "Puesto de Salud Fortalecido";
			$municipality = "San Cristobal Totonicapan";
			$department = "Totonicapan";
			$dms = "San Cristobal Totonicapan";
			$das = "Totonicapan";
			$location_lat = 14.9438944;
			$location_long = -91.50281891;
		}	
		else if($message_elements[0]=="80104"){			
			$location_description = "San Ramon";
			$facilityType = "Puesto de Salud Fortalecido";
			$municipality = "San Cristobal Totonicapan";
			$department = "Totonicapan";
			$dms = "San Cristobal Totonicapan";
			$das = "Totonicapan";
			$location_lat = 14.86239795;
			$location_long = -91.4296936;
		}	
		else if($message_elements[0]=="91201"){			
			$location_description = "Cajola";
			$facilityType = "Centro de Atencion Permanente";
			$municipality = "Cajola";
			$department = "Quetzaltenango";
			$dms = "Cajola";
			$das = "Quetzaltenango";
			$location_lat = 14.92379731;
			$location_long = -91.61324331;
		}	
		else if($message_elements[0]=="91211"){			
			$location_description = "Cajola Chiquito";
			$facilityType = "Puesto de Salud";
			$municipality = "Cajola";
			$department = "Quetzaltenango";
			$dms = "Cajola";
		...
		else if($message_elements[0]=="91210"){			
			$location_description = "Xetabijoj";
			$facilityType = "Puesto de Salud";
			$municipality = "Cajola";
			$department = "Quetzaltenango";
			$dms = "Cajola";
			...
			$location_description = "Concepcion Chiquirichapa";
			$facilityType = "Centro de Salud";
			$municipality = "Concepcion Chiquirichapa";
			$department = "Quetzaltenango";
			$dms = "Concepcion Chiquirichapa";
			$das = "Quetzaltenango";
			$location_lat = 14.85952979; 
			$location_long = -91.61916444; 
		}	
		else if($message_elements[0]=="91501"){			
			$location_description = "Palestina De Los Altos";
			$facilityType = "Centro de Atencion Permanente";
			$municipality = "Palestina De Los Altos";
			$department = "Quetzaltenango";
			$dms = "Palestina De Los Altos";
			$das = "Quetzaltenango";
			$location_lat = 14.93326002; 
			$location_long = -91.69457462; 
		}	
		else if($message_elements[0]=="91504"){			
			$location_description = "El Carmen";
			$facilityType = "Puesto De Salud";
			$municipality = "Palestina De Los Altos";
			$department = "Quetzaltenango";
			$dms = "Palestina De Los Altos";
			$das = "Quetzaltenango";
			$location_lat = 14.91376105; 
			$location_long = -91.70086096; 
		}	
		else if($message_elements[0]=="91502"){			
			$location_description = "El Eden";
			$facilityType = "Puesto De Salud";
			$municipality = "Palestina De Los Altos";
			$department = "Quetzaltenango";
			$dms = "Palestina De Los Altos";
			$das = "Quetzaltenango";
			$location_lat = 14.95468128; 
			$location_long = -91.65926362; 
		}	
		else if($message_elements[0]=="91503"){			
			$location_description = "San Jose Buena Vista";
			$facilityType = "Puesto De Salud Fortalecido";
			$municipality = "Palestina De Los Altos";
			$department = "Quetzaltenango";
			$dms = "Palestina De Los Altos";
			$das = "Quetzaltenango";
			$location_lat = 14.91861775; 
			$location_long = -91.67480558; 
		}	
